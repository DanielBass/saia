        ...
        <div class="col-md-4">
          <?php
            ...
            if($idUsuario == 3){
                ...
                $sql=("SELECT * FROM usuarios where  id_usuario != 3");  
            }  
            ...
            if($sql->rowCount() > 0){
              ...
              foreach ($sql->fetchAll() as $item){
                ...
                echo "<tr>";
                    ...
                    echo "<td><button  type='button'  value='editarusuario.php?id=".$item['id_usuario']."'class='btn btn-warning bAlterar'  </button><i class='fas fa-cog'></i></td>";

                    echo "<td><button  type='button' class='btn btn-danger bExcluir' value='deletarprocesso.php?id=".$item['id_usuario']."'</button><i class='far fa-trash-alt'></i></td>";
