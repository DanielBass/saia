...
<html lang="en">
  ...
  <body id="body">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="">Configuração</a> 

                  <div class="dropdown-menu">  
                    <?php
                        if($idUsuario == 3){
                          echo "<a class='nav-link  dropdown-item text-primary' data-toggle='modal' data-target='#modalCadastrarUsuario' data-whatever='@pro' href=''>Cadastrar Usuário</a>";
                          echo"<a class='nav-link dropdown-item text-primary'  href='mostrarusuario.php'>Usuários</a>";

                        }
                    ?>
                    

                    <a class="nav-link  dropdown-item text-primary" data-toggle="modal" data-target="#modalMudarSenha" data-whatever="@pro" href="">Mudar senha</a>
    ...
    <div class="container">
        <div class="row">
          <div class="col-5"https://localhost/tcc/imagens/logo.bmp>
              <img src="imagens/logo.bmp">
          </div>
        </div>
    </div>
...
<div class="modal fade" id="modalGrafico" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Informação parar Gerar o relatório</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- fim modal de cadastro processo-->
...
<div class="modal fade" id="modalCadastrarUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="formUsuario">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nomeUsuario" name="nomeUsuario" placeholder="Digite nome do usuario">
          </div>
          <div class="form-group">
            <label for="senha1" class="col-form-label">Senha:</label>
            <input type="password" class="form-control" id="senha1" name="senha1" placeholder="Digite a senha">
          </div>

          <div class="form-group">
            <label for="senha2" class="col-form-label">Confimar a senha:</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-dark" data-dismiss="modal"><i class="far fa-times-circle"></i>&nbsp;Sair</button>
        <button type="button" class="btn btn-success" id="cadastrarUsuario" ><i class="far fa-save"></i>&nbsp;Cadastrar</button>
      </div>
    </div>
  </div>
</div>
<!-- fim modal de cadastro usuario-->
...
<div class="modal fade" id="modalMudarSenha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="formSenha">
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="senhaantiga" name="senhaantiga" placeholder="Digite nome do usuario">
          </div>
          <div class="form-group">
            <label for="senhanova1" class="col-form-label">Senha:</label>
            <input type="password" class="form-control" id="senhanova1" name="senhanova1" placeholder="Digite a senha">
          </div>

          <div class="form-group">
            <label for="senhanova2" class="col-form-label">Confimar a senha:</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-dark" data-dismiss="modal"><i class="far fa-times-circle"></i>&nbsp;Sair</button>
        <button type="button" class="btn btn-success" id="cadastrarSenha" ><i class="far fa-save"></i>&nbsp;Cadastrar</button>
      </div>
    </div>
  </div>
</div>
<!-- fim modal de alterar senha-->
...
<div class="modal fade" id="modalCriticidade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-dark" data-dismiss="modal"><i class="far fa-times-circle"></i>&nbsp;Sair</button>
        <button type="submit" class="btn btn-success" id="gerarCriticidade">Ver</button>
      </div>
    </form>
    </div>
  </div>
