...
<div class="container">
  <div class="row">
    <div class="col-md-12" id="conteudo">
        ...
        <form method="POST" id="formProcessoEdit">
          <div class="form-group">
            <div class="container">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="nomeProcessoEd" class="col-form-label">Processo:</label>
                  <?php 
                      ...
                      $idUsuario=$_SESSION ['idUsuario'];
                      $idProcesso= $_GET['id'];
                      $_SESSION['idProcesso'] =$_GET['id'];
                      
                          
                          $sql=$db->query("SELECT * FROM processos WHERE id_processo='$idProcesso' AND id_usuario='$idUsuario'");
                          if($sql->rowCount()>0){
                            $y=$sql->fetch();
                              echo "<input type='text' class='form-control' id='nomeProcessoEd' name='nomeProcessoEd' value='".$y['nomeProcesso']."'>";
              ...
              <div class="form-group col-md-8">
                <label for="observacaoEd" class="col-form-label">Obsevação:</label>
                <?php 
                      ...
                      $idProcesso= $_GET['id'];
                          ...
                          if($sql->rowCount()>0){
                            $y=$sql->fetch();
                              echo "<textarea  class='form-control' id='observacaoEd' name='observacaoEd'>".$y['observacao']."</textarea>";
        ...
        <div class="text-center mt-4">
          <button type="button" class="btn btn-warning" id="voltarProcesso" ><i class="fas fa-undo-alt"></i>&nbsp;Voltar aos Processos</button>    
          <button type="button" class="btn btn-success" id="editarProcesso" ><i class="far fa-save"></i>&nbsp;Editar</button>  
        </div> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="formEtapa">
          <div class="form-group">
            <label for="nomeProcesso" class="col-form-label">Selecione o processo:</label>
            <select name="nomeProcesso" id="nomeProcesso" class="form-control input-lg" data-live-search="true"> </select>
          </div>
          <div class="form-group">
...
$(document).ready(function(){
 ...
 $('#voltarProcesso').click(function(){
    
    window.location.href = 'mostrarprocesso.php'
    
  }); 
        
  $('#editarProcesso').click(function(){


    $.ajax({

      url:"editarprocessoajax.php",
      method:"POST",
      data:$('#formProcessoEdit').serialize(),
      dataType:"json",
      success:function(e) {
