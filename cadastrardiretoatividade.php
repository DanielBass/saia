              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <?php
                    require_once("banco2.php");
                      ...
                      $sql=$db->query("SELECT * FROM etapas  WHERE id_usuario = '$idUsuario' AND id_processo = '$idProcesso'   ORDER BY id_etapa DESC LIMIT 1");
                      if($sql->rowCount()>0){
                            $y=$sql->fetch();
                            $_SESSION['etapaD'] = $y['id_etapa'];
                ...
                <div class="form-group col-md-3">
                  <label for="nomeAtividade" class="col-form-label">Atividade:</label>
                   <input type="text" class="form-control" id="nomeAtividade" name="nomeAtividade" placeholder="Digite nome da Atividade">
              </div>
...
<script type="text/javascript">
  //principal função do jquery
    ...
    let NPAElemento =document.getElementById("nomeProcessoA");
      NPAElemento.style.backgroundColor = "#007bff";
      NPAElemento.style.color ="white";

    let NEAElemento =document.getElementById("nomeEtapaA");
      NEAElemento.style.backgroundColor = "#007bff";
      NEAElemento.style.color ="white";
...
$('#formAtividade').on("submit",function(x){
    ...
    $.ajax({
      url:"cadastraratividadediretoajax.php",
      method:"POST",
      data:form_data,
      dataType:"JSON",
      processData:false,
