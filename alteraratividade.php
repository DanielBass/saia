...
<div class="container">
  <div class="row">
    <div class="col-md-12" id="conteudo">
        ...
        <form method="POST" enctype="multipart/form-data" id="formAtividade">
          <div class="form-group">
            <div class="container">
              <div class="row">
                <div class="form-group col-md-3">
                  <label for="nomeProcessoA" class="col-form-label">Processo:</label>
                  <div id="divProcesso"></div>
                    <?php 
                      ...
                      $idUsuario=$_SESSION ['idUsuario'];
                      $idAtividade= $_GET['id'];
                      $sql=$db->query("SELECT * FROM atividades WHERE id_usuario='$idUsuario' AND id_atividade ='$idAtividade'");
                      if($sql->rowCount()>0){
                          $x=$sql->fetch();
                          $idProcesso=$x['id_processo'];
                          $_SESSION['nomeProcessoT']=$idProcesso;
                          $sql2=$db->query("SELECT * FROM processos WHERE id_processo='$idProcesso'");
                          if($sql2->rowCount()>0){
                            $y=$sql2->fetch();
                              echo "<input type='text' class='form-control' id='nomeProcessoA' name='nomeProcessoA' value='".$y['nomeProcesso']."' readonly='readonly'>";
                          }
                ...
                <div class="form-group col-md-3">
                  <label for="nomeEtapaA" class="col-form-label">Etapa:</label>
                  <div id="divEtapa"></div>
                  <?php 
                      ...
                      if($sql->rowCount()>0){
                          $x=$sql->fetch();
                          $idEtapa=$x['id_etapa'];
                          $sql2=$db->query("SELECT * FROM etapas WHERE id_etapa='$idEtapa'");
                          if($sql2->rowCount()>0){
                            $y=$sql2->fetch();
                              echo "<input type='text' class='form-control' id='nomeEtapaA' name='nomeEtapaA' value='".$y['nomeEtapa']."' readonly='readonly'>";
                          }
                ...
                <div class="form-group col-md-3">
                  ...
                  <?php 
                      ...
                      if($sql->rowCount()>0){
                        ...
                        echo "<input type='text' class='form-control' id='nomeAtividade' name='nomeAtividade' value='".$nomeAtividade."' >";
              ...
              <div class="form-group col-md-3">
                <label for="itemAjax" class="col-form-label">Item:</label>
                <select class="form-control" id="itemAjax" name="itemAjax">
                  <option class="form-control"  selected disabled>-- Selecione --</option>
                  <option class="form-control" value="1" >Particulas sólidas</option>
                  <option class="form-control" value="2" >Gases e vapores</option>
                  <option class="form-control" value="3" >Contaminação da água</option>
                  <option class="form-control" value="4" >Contaminação do solo</option>
                  <option class="form-control" value="5" >Redução da diversidade</option>
                  <option class="form-control" value="6" >Economia Local</option>
                  <option class="form-control" value="7" >Infraestrutura</option>
                  <option class="form-control" value="8" >Tecnologia</option>
                  <option class="form-control" value="9" >Qualidade de vida</option>
                  <option class="form-control" value="10" >Saúde</option>
                  <option class="form-control" value="11" >Desenvolvimento Regional</option>
                  <option class="form-control" value="12" >Paisagimos</option>
                  <option class="form-control" value="13" >Qualidade do Produto Final</option>
                </select>
                ...
                <div id="divImgBanco" class="form-group col-md-3">
                 <img src="" heigth="200" height="200" id="imagemBanco"/>
              </div>
            </div>
            </div>
        ...
        <div class="text-center mt-4">
          <button type="button" class="btn btn-warning" id="voltarTabela" ><i class="fas fa-undo-alt"></i>&nbsp;Voltar Tabela</button>    
          <input  type="submit" class="btn btn-success" id="alterarAtividade" >  
        </div> 
...
<script type="text/javascript">
  //principal função do jquery
    ...
    console.log (optionE)
    let NPElemento =document.getElementById("nomeProcessoA");
      NPElemento.style.backgroundColor = "#007bff";
      NPElemento.style.color ="white";

      let NEElemento =document.getElementById("nomeEtapaA");
      NEElemento.style.backgroundColor = "#007bff";
      NEElemento.style.color ="white";
...
$(document).ready(function(){
  ...
  $('#itemAjax').change(function(){

    $.ajax({
        url:"selecionarradioajax.php",
        method:"POST",
