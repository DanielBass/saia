<?php
    ...
    if(!isset($_SESSION)){
     ...
     require_once("relatorio01back.php");
...
<html lang="en">
  <head>
    ...
    <title>Relatório de indeficação de impactos</title>
  </head>
  <body id="body">
    <div id="alertModal">
    </div>
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="nav-link  dropdown-item text-primary" data-toggle="modal" data-target="#modalRelatorio01" data-whatever="@pro" href="">Relatório de indeficação de impactos</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success" id="gerarAnalise" >Gerar</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="modalFoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Relatório Fotos</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- fim modal Criticidade-->
 ...
 <div id="telaRelatorio01">

    <div>
      <h3 class="h33 text-center"><?php echo ($_SESSION['string01']);?><h3>
    </div>
    <div>    
      <h4 class="h44 text-center"><?php echo ($_SESSION['string02']);?></h4>
    </div>
    <div>
      <br/>
      <p class="pp "><?php echo ($_SESSION['string03']);?></p>
    <div>
