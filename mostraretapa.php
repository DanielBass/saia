      ...
      <div class="row">
        <div class="col-md-4">
          <?php
            ...
            $sql=("SELECT * FROM etapas where 1");
            $sql=$db->query($sql);
            ...
            if($sql->rowCount() > 0){
              ...
              foreach ($sql->fetchAll() as $item){
                ...
                echo "<tr>";
                    ...
                    echo "<td>".$item['nomeEtapa']."<td>";
                    
                    echo "<td><button  type='button'  value='editaretapa.php?id=".$item['id_etapa']."'class='btn btn-warning bAlterar'  </button><i class='fas fa-cog'></i></td>";

                    echo "<td><button  type='button' class='btn btn-danger bExcluir' value='deletaretapa.php?id=".$item['id_etapa']."'</button><i class='far fa-trash-alt'></i></td>";
