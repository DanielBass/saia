        ...
        <form action="relatorio01front.php" method="POST" id="relatorio01">
          ...
          <div class="form-group" id="divSelect01">
              ...
              <select name="Select01" id="Select01" class="form-control input-lg">
                ...
                <option class="form-control"  value="espacial-L">Espacial-Local</option>
                ...
                <option class="form-control"  value="condicoes-N">Condições-Normais</option>
                <option class="form-control"  value="condicoes-A">Condições-Anormais</option>
...
<?php
    ...
    function calculando( $iniciais){
                            ...
                            switch($letra){
                                 ...
                                 case 'P':
                                    ...
                                    $GLOBALS['significancia1']++;

                                 break;

                                 case 'M':
                                                        
                                    $GLOBALS['significancia2']++;                    

                                 break;

                                 case 'G':
                                        
                                    $GLOBALS['significancia3']++;
                            ...
                            switch($letra){
                                ...
                                switch($letra){
                                     ...
                                     case 'M':
                                        ...
                                        $GLOBALS['sensibilidade2']++;

                                     break;

                                     case 'A':
                                        
                                        $GLOBALS['sensibilidade3']++;
                                ...
                                switch($letra){
                                     ...
                                     case 'P':
                                        ...
                                        $GLOBALS['cumulatividade1']++;

                                     break;

                                     case 'A':
                                        
                                        $GLOBALS['cumulatividade2']++;
                                ...
                                switch($letra){
                                     ...
                                     case 'I':
                                        ...
                                        $GLOBALS['resistencia1']++;

                                     break;

                                     case 'M':
                                        
                                        $GLOBALS['resistencia2']++;                                        

                                     break;

                                     case 'E':
                                        
                                        $GLOBALS['resistencia3']++;
    ...
    if(isset($_SESSION ['idUsuario']) && empty($_SESSION ['idUsuario'])==false ){
        ...
        $dado= $sql->fetch();
        echo "<div class='text-center'><h1>".$dado['nomeProcesso']."</h1><div>";

        echo "<div class='text-center h44'><h4><br><br>Nesse relatório mostraremos a porcentagem dos itens cadastrado no processo ({$dado['nomeProcesso']})<br><br></h4><div>";
        ...
        $p1 = number_format(($valor1*100)/($valor1+$valor2),2);
        $p2 = number_format(($valor2*100)/($valor1+$valor2),2);    
        ...
        $p1 =number_format(($dinamica1*100)/($dinamica1+$dinamica2+$dinamica3),2);
        $p2 =number_format(($dinamica2*100)/($dinamica1+$dinamica2+$dinamica3),2);
        $p3 =number_format(($dinamica3*100)/($dinamica1+$dinamica2+$dinamica3),2);
        echo "</br>";
        echo "<b>Dinâmica</b>";
        echo "</br>";
        echo "Temporário cíclico ".$p1."%";
        echo "</br>";
        echo "Cíclico ".$p2."%";
        echo "</br>";
        echo "Permanente ".$p3."%";
        ...
        $p1 =number_format(($significancia1*100)/($significancia1+$significancia2+$significancia3),2);
        $p2 =number_format(($significancia2*100)/($significancia1+$significancia2+$significancia3),2);
        $p3 =number_format(($significancia3*100)/($significancia1+$significancia2+$significancia3),2);
        echo"</br>";	
        echo "<b>Significância</b>"; 
        echo "</br>";
        echo "Pequena ".$p1."%";
        echo "</br>";
        echo "Média ".$p2."%";
        ...
        $p1 = number_format(($ordem1*100)/($ordem1+$ordem2),2);
        $p2 = number_format(($ordem2*100)/($ordem1+$ordem2),2);    
        echo"</br>"; 
        echo "<b>Ordem</b>";
        echo "</br>";
        echo "Direto ".$p1."%";
        ...
        echo "Indireto ".$p2."%";
        echo "</br>";
        $p1 = number_format(($plastica1*100)/($plastica1+$plastica2),2);
        $p2 = number_format(($plastica2*100)/($plastica1+$plastica2),2);    
        echo"</br>"; 
        echo "<b>Plática</b>";
        echo "</br>";
        echo "Reversível ".$p1."%";
        echo "</br>";
        echo "Irreversível ".$p2."%";
        echo "</br>";
        $p1 =number_format(($sensibilidade1*100)/($sensibilidade1+$sensibilidade2+$sensibilidade3),2);
        $p2 =number_format(($sensibilidade2*100)/($sensibilidade1+$sensibilidade2+$sensibilidade3),2);
        $p3 =number_format(($sensibilidade3*100)/($sensibilidade1+$sensibilidade2+$sensibilidade3),2);
        echo"</br>"; 
        echo "<b>Sensibilidade</b>";    
        echo "</br>";
        echo "Baixa ".$p1."%";
        echo "</br>";
        echo "Média ".$p2."%";
        ...
        echo "Alta ".$p3."%";
        echo "</br>";
        $p1 =number_format(($espacial1*100)/($espacial1+$espacial2+$espacial3),2);
        $p2 =number_format(($espacial2*100)/($espacial1+$espacial2+$espacial3),2);
        $p3 =number_format(($espacial3*100)/($espacial1+$espacial2+$espacial3),2);
        echo"</br>"; 
        echo "<b>Espacial</b>";    
        echo "</br>";
        echo "Local ".$p1."%";
        ...
        echo "Estratégico ".$p3."%";
        echo "</br>";
        $p1 = number_format(($cumulatividade1*100)/($cumulatividade1+$cumulatividade2),2);
        $p2 = number_format(($cumulatividade2*100)/($cumulatividade1+$cumulatividade2),2);    
        echo"</br>"; 
        echo "<b>Cumulatividade</b>";
        echo "</br>";
        echo "Presente ".$p1."%";
        echo "</br>";
        echo "Ausente ".$p2."%";
        echo "</br>";
        $p1 = number_format(($condicoes1*100)/($condicoes1+$condicoes2),2);
        $p2 = number_format(($condicoes2*100)/($condicoes1+$condicoes2),2);    
        echo"</br>"; 
        echo "<b>Condições</b>";
        echo "</br>";
        echo "Normais ".$p1."%";
        ...
        echo "Anormais ".$p2."%";
        echo "</br>";
        $p1 =number_format(($temporal1*100)/($temporal1+$temporal2+$temporal3),2);
        $p2 =number_format(($temporal2*100)/($temporal1+$temporal2+$temporal3),2);
        $p3 =number_format(($temporal3*100)/($temporal1+$temporal2+$temporal3),2);
        echo"</br>"; 
        echo "<b>Temporal</b>";    
        echo "</br>";
        echo "Curto prazo ".$p1."%";
        ...
        $p1 =number_format(($magnitude1*100)/($magnitude1+$magnitude2+$magnitude3),2);
        $p2 =number_format(($magnitude2*100)/($magnitude1+$magnitude2+$magnitude3),2);
        $p3 =number_format(($magnitude3*100)/($magnitude1+$magnitude2+$magnitude3),2);
        echo"</br>"; 
        echo "<b>Magnitude</b>";    
        echo "</br>";
        echo "Fraco ".$p1."%";
        ...
        echo "Forte ".$p3."%";
        echo "</br>";         	
        $p1 =number_format(($resistencia1*100)/($resistencia1+$resistencia2+$resistencia3),2);
        $p2 =number_format(($resistencia2*100)/($resistencia1+$resistencia2+$resistencia3),2);
        $p3 =number_format(($resistencia3*100)/($resistencia1+$resistencia2+$resistencia3),2);
        echo"</br>"; 
        echo "<b>Resistência</b>";    
        echo "</br>";
        echo "Irredutível ".$p1."%";
        echo "</br>";
        echo "Mitigável ".$p2."%";
