...
<div class="modal fade" id="modalRelatorio01" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="relatorio01back.php" method="POST" id="relatorio01">
          ...
          <div class="form-group" id="divSelect01">
              ...
              <select name="Select01" id="Select01" class="form-control input-lg">
                ...
                <option class="form-control"  value="espcial-P">Epacial-Local</option>
                <option class="form-control"  value="espacial-R">Epacial-Regional</option>
                <option class="form-control"  value="espacial-E">Epacial-Estratégico</option>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-dark" data-dismiss="modal"><i class="far fa-times-circle"></i>&nbsp;Sair</button>
          <input  type="submit" class="btn btn-success" id="cadastrarRelatorio01" ><i class="far fa-save"></i>&nbsp;Cadastrar</button>
      </div>  
  </form>
...
<form method="post" enctype="multipart/form-data" id="myform">
  <h1></h1>
  <input type="file" name="imagem" id="imagemIndex" class="form-control">
  <input type="submit" name="submit" id="submit" class="btn btn-warning" value="upload"> 
</form>
