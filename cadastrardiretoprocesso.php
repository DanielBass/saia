...
<html lang="en">
  ...
  <body id="body">
    ...
    <form method="POST" id="formProcessoD">
          <div class="form-group">
            <div class="container">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="nomeProcessoD" class="col-form-label">Processo:</label>
                  <input type='text' class='form-control' id='nomeProcessoD' name='nomeProcessoD' placeholder="Digite o nome do novo processo">
    ...
    <div class="text-center mt-4">
      ...
      <button type="button" class="btn btn-success" id="cadastrarProcessoD" ><i class="far fa-save"></i>&nbsp;Cadastra</button>  
    </div> 
...
$(document).ready(function(){
  ...
  $('#cadastrarProcessoD').click(function(){

  //alert ('testando evento no botão')  
    
    
    $.ajax({
      url:"cadastrarprocessodiretoajax.php",
      method:"POST",
      data:$('#formProcessoD').serialize(),
      dataType:"json",
      success:function(e){
         ...
         let modal=`<div class="content float-letf"> <div class="row"> <div class="col-md-3 ml-auto" > <div class="alert ${e[0].alert}" role="alert"> <h5 class="alert-heading">${e[0].status}</h5> <p>${e[0].mensagem}</p> <hr> </div> </div> </div> </div>`   
          ...
          if(e[0].status == 'sucesso'){
            window.location.href ='cadastrardiretoetapa.php' 
          }
 ...
 setTimeout(function () {
      ...
      let campoprocesso =$('#nomeProcessoD').val();
