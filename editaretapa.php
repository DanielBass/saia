...
<div class="container">
  <div class="row">
    <div class="col-md-12" id="conteudo">
        ...
        <form method="POST" id="formEtapaEdit">
          <div class="form-group">
            <div class="container">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="nomeEtapaEd" class="col-form-label">Etapa:</label>
                  <?php 
                      ...
                      $idUsuario=$_SESSION ['idUsuario'];
                      $idEtapa= $_GET['id'];
                      $_SESSION['idEtapa'] =$_GET['id'];
                      
                          
                          $sql=$db->query("SELECT * FROM etapas WHERE id_etapa='$idEtapa' AND id_usuario='$idUsuario'");
                          if($sql->rowCount()>0){
                            $y=$sql->fetch();
                              echo "<input type='text' class='form-control' id='nomeEtapaEd' name='nomeEtapaEd' value='".$y['nomeEtapa']."'>";
        ...
        <div class="text-center mt-4">
          <button type="button" class="btn btn-warning" id="voltarEtapa" ><i class="fas fa-undo-alt"></i>&nbsp;Voltar as Etapas</button>    
          <button type="button" class="btn btn-success" id="editarEtapa" ><i class="far fa-save"></i>&nbsp;Editar</button>  
        </div> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="formProcesso">
          ...
          <div class="form-group">
            <label for="observacao" class="col-form-label">Obsevação:</label>
...
$(document).ready(function(){
 ...
 $('#voltarEtapa').click(function(){
    
    window.location.href = 'mostraretapa.php'
  ...
  $('#editarEtapa').click(function(){
    ...
    $.ajax({
      ...
      url:"editaretapaajax.php",
      method:"POST",
      data:$('#formEtapaEdit').serialize(),
      dataType:"json",
      success:function(e) {
